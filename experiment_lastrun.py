...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.81.02), So 23 Nov 16:10:02 2014
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/Anita/Documents/Studium/UPF/Research Methodologies in Humanities and Science/Final Experiment PsychoPy/experiment.psyexp',
...
sound_1 = sound.Sound(u'Maria.wav')
sound_1.setVolume(1)
...
questionnaire2 = visual.TextStim(win=win, ori=0, name='questionnaire2',
    ...
    units='pix', pos=[1,1], height=50, wrapWidth=1000,
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0)
...
thanks = visual.TextStim(win=win, ori=0, name='thanks',
    text=u'Thank you for participating!\n\nPress any key to finish.',    font=u'Arial',
    units='pix', pos=[0, 0], height=50, wrapWidth=None,
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0)
...
questions1 = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=u'/Users/Anita/Documents/Studium/UPF/Research Methodologies in Humanities and Science/Final Experiment PsychoPy/experiment.psyexp',
    trialList=data.importConditions(u'questionnaire2.xlsx'),
...
questions2 = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=u'/Users/Anita/Documents/Studium/UPF/Research Methodologies in Humanities and Science/Final Experiment PsychoPy/experiment.psyexp',
    trialList=data.importConditions(u'questionnaire_Maria.xlsx'),
